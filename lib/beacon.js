...
/*** Advertise Eddystone-UID-PSW Beacons ***/
Beacon.prototype.advertisePswUid = function(namespaceId, instanceId, options) {
    this._parseOptions(options);

    this._advertisementData = AdvertisementData.makePswUidBuffer(namespaceId, instanceId, this._txPowerLevel);
...
/*** Node.js methods for Eddystone-URL-PSW Beacons ***/
Beacon.prototype.advertisePswUrl = function(url, options) {
    this._parseOptions(options);

    this._advertisementData = AdvertisementData.makePswUrlBuffer(url, this._txPowerLevel);
    this._removeFlagsIfOsX();
