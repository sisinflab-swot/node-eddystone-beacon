...
var makePswUidBuffer = function (namespaceId, instanceId, txPowerLevel) {
    ...
    return makeEddystoneBuffer(UID_PSW_FRAME_TYPE, data);
};

var makePswUrlBuffer = function (url, txPowerLevel) {
    ...
    return makeEddystoneBuffer(URL_PSW_FRAME_TYPE, data);
};
...
module.exports = {
	...
	makePswUidBuffer: makePswUidBuffer,
	makePswUrlBuffer: makePswUrlBuffer
};
